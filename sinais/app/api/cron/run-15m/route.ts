...
/**
 * Cron 15m: MA Cross 12×30 + Pivot Boss Bear 15m + Rompimento de Acumulação 15m + Quebra EMA80.
 */
async function run15mInBackground(now: Date): Promise<void> {
  console.log('[Run-15m BG] Iniciando MA Cross + Pivot Boss + Rompimento + Quebra EMA80...');
...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: 'MA Cross + Pivot Boss + Rompimento + Quebra EMA80 iniciado em background',
