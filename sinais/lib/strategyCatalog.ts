...
export const STRATEGY_CATALOG: Record<string, StrategyCatalogEntry> = {
  ...
  ROMPIMENTO_20_15M: {
    ...
    universe: 'Scanner 1 top 20; fecho > máx. 20 velas; filtro ≤30% acima EMA70; LONG SL −5% | TP +9% 50%',
  ...
  SCANNER3_RSI_FLIP_1H: {
    ...
    universe: 'Scanner 3 RSI > 75 (1h) ranks 6–14; LONG SL 5%/72h; SHORT SL 5%/24h; flip RSI 15m < 70',
