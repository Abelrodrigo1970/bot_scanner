...
| `/api/cron/run-scanner1-top5` | Scanner 1 Top 8 (rotação manual/backup) | opcional, 10–15 min após scan |
...
Opcional backup: **Top 6** — `run-scanner1-top8` — `15 */4 * * *` | **Top 8** — `run-scanner1-top5` — `20 */4 * * *`
