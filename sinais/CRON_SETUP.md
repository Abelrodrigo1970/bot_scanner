...
|----------|-------------|------------|
| `/api/cron/run-15m` | **Liquidity Pools** + **Swing VWAP** (S2) + **MA Cross 12×30** (S1) + **MA Cross 12×21** (S7) + **engolfo** (S2) + **Rompimento 20** (S1) + **rsi_vendido** (S7) + **sync SL Bybit** | `*/15 * * * *` (24h) |
...
1. **Liquidity Pools + Swing VWAP + MA Cross + engolfo + Rompimento 20 + rsi_vendido (15m)** — `run-15m` — `*/15 * * * *`
